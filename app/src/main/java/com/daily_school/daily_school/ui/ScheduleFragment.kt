...
class ScheduleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.bottomNavPlan.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.action_scheduleFragment_to_planFragment)
        }

        binding.bottomNavMeal.setOnClickListener {

            it.findNavController().navigate(R.id.action_scheduleFragment_to_mealFragment)
        }

        binding.bottomNavProfile.setOnClickListener {

            it.findNavController().navigate(R.id.action_scheduleFragment_to_profileFragment)
        }
